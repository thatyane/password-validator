...
@Log4j2
public class HasNoSpace extends PasswordValidatorStep implements RegexValidator {

    @Override
    public boolean validate(String password) {
        boolean result = !match("\\s", password);
        log.info("The password has no space: {}", result);
